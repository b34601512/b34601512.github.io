...
- `index.html`：首页。极简介绍 + 可交互演示（紧跟首屏）+ 功能 + 常见问题。
...
- 首页首屏下方直接是可交互演示（不再有「三步用起来」小节，也不放产品截图）：先让人上手点，再讲功能与常见问题。加内容优先往演示区或功能里加，不要再往首屏下塞过渡性小节。
...
首页 H2 落点：可交互界面实操试用 / 功能 / 常见问题。**不放产品截图**——交互演示已经够真实，截图是多余的（用户明确要求砍掉）。
